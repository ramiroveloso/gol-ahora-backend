...
# =========================================================================
# CONFIGURACIÓN DE SEGURIDAD CORS Y CSRF PARA REACT (UNIFICADA)
# =========================================================================
...
# Orígenes que Django aceptará para validar tokens de seguridad y formularios
...
APPEND_SLASH = False    'corsheaders.middleware.CorsMiddleware',  # CORS — antes de CommonMiddleware
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
